...
public class Test {
	public static void main(String[] args) throws Exception {
		/*
		 * SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd"); Long
		 * time=new Long(1546099200); Date date = new Date(time);
		 * System.out.println(simpleDateFormat.format(date));
		 */
		System.out.println(AES128.encrypt("123456", "nanjing"));
	}
